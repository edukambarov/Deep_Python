...
class TestEmployee:
    ...
    def test_employee_full_name(self):
        ...
        assert 'Ivanov Ivan Ivanovich' == a.full_name()
    ...
    def test_employee_raise_salary(self):
        ...
        a.raise_salary(10)
        assert 55000.00000000001 == a.salary

    def test_employee_str(self):
        a = Employee('ivanov', 'ivan', 'ivanovich', 30, 'manager', 50000)
        assert 'Ivanov Ivan Ivanovich (Manager)' == str(a)

    def test_employee_last_name_title(self):
        a = Employee ('ivanov', 'ivan', 'ivanovich', 30, 'manager', 50000)
        assert 'Ivanov' == a.last_name
