...
# Исходный код в редакторе кода надо доработать,
# чтобы вызывалось исключение NegativeValueError.
#
...
# а создание r4 вызывает исключение NegativeValueError с текстом
...
class NegativeValueError(Exception):
    ...
    def __init__(self, attr_name: str, parameter: int):
        self.attr_name = attr_name
        self.parameter = parameter

    def __str__(self):
        if self.attr_name == "width":
            return f'Ширина должна быть положительной, а не {self.parameter}'
        elif self.attr_name == "height":
            return f'Высота должна быть положительной, а не {self.parameter}'
class Rectangle:
    """
    ...
    def __init__(self, width, height=None):
        ...
        ...
        sem14_hw1.NegativeValueError: Ширина должна быть положительной, а не -2
        >>> r2 = Rectangle(3, 4)
        >>> r2.width
        3
        >>> r2.height
