...
class TestRectangle(unittest.TestCase):
    ...
    def test_width(self):
        self.assertEqual(5, Rectangle(5).width)

    def test_height(self):
        self.assertEqual(4, Rectangle(3,4).height)


    def test_perimeter(self):
        self.assertEqual(20, Rectangle(5).perimeter())
    ...
    def test_addition(self):
        ...
        r2 = Rectangle(3,4)
        r3 = r1 + r2
        self.assertEqual(8, r3.width)
        self.assertEqual(9.0, r3.height)
